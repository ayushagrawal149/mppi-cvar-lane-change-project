...
## Configuration
- folder: `20260531-192010_hard_brake`
- scenario: `hard_brake`
- seed: 3
...
|---|---:|---:|---:|---:|:---|
| a_y,peak [m/s^2] | 23.30 | <= 1.5 | <= 2.0 | 2.5 (ISO 11270) | exceeds hard limit |
| j_y,peak [m/s^3] | 97.47 | <= 0.9 | <= 2.0 | 5.0 | exceeds hard limit |
| TTC_min [s] | 0.50 | >= 4 | >= 3 | 2 (ISO 17387) | below hard limit |
| e_y,RMS [m] | 0.110 | <= 0.05 | <= 0.10 | 0.25 | exceeds acceptable, within hard limit |
| T_LC [s] | 6.45 | 4-5 | 3-6 | outside [2, 8] flagged | outside acceptable range |
