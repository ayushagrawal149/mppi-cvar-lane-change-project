# Run: lane_change_to_right

## Configuration
- folder: `20260510-160020_lane_change_to_right`
- scenario: `lane_change_to_right`
- seed: 0
...
|---|---:|---:|---:|---:|:---|
| a_y,peak [m/s^2] | 44.23 | <= 1.5 | <= 2.0 | 2.5 (ISO 11270) | exceeds hard limit |
| j_y,peak [m/s^3] | 690.91 | <= 0.9 | <= 2.0 | 5.0 | exceeds hard limit |
| TTC_min [s] | 10.11 | >= 4 | >= 3 | 2 (ISO 17387) | comfortable |
| e_y,RMS [m] | 0.281 | <= 0.05 | <= 0.10 | 0.25 | exceeds hard limit |
