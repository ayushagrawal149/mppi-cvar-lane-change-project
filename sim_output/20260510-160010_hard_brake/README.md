...
## Configuration
- folder: `20260510-160010_hard_brake`
- scenario: `hard_brake`
- seed: 1
...
|---|---:|---:|---:|---:|:---|
| a_y,peak [m/s^2] | 64.84 | <= 1.5 | <= 2.0 | 2.5 (ISO 11270) | exceeds hard limit |
| j_y,peak [m/s^3] | 893.70 | <= 0.9 | <= 2.0 | 5.0 | exceeds hard limit |
| TTC_min [s] | 1.44 | >= 4 | >= 3 | 2 (ISO 17387) | below hard limit |
| e_y,RMS [m] | 4.849 | <= 0.05 | <= 0.10 | 0.25 | exceeds hard limit |
